  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_statements() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, st) {return st;})(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_statement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expr, body) { return { tag: "if", 
                           expr: expr, body: body }; })(pos0, result0[4], result0[10]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, expr, body) { return { tag: "repeat", 
                             expr: expr, body: body }; })(pos0, result0[4], result0[10]);
          }
          if (result0 === null) {
            pos = pos0;
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, expr, body) { return { tag: "while", 
                               expr: expr, body: body }; })(pos0, result0[4], result0[10]);
            }
            if (result0 === null) {
              pos = pos0;
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, v) { return { tag: "var", name: v, val: 0 }; })(pos0, result0[3]);
              }
              if (result0 === null) {
                pos = pos0;
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, v, expr) { return { tag: "var", name: v, val:expr }; })(pos0, result0[3], result0[7]);
                }
                if (result0 === null) {
                  pos = pos0;
                }
                if (result0 === null) {
                  ...
                  if (result0 !== null) {
                    result0 = (function(offset, v, body) { return { tag:"define", 
                                     name:v, args:[], body:body }; })(pos0, result0[3], result0[11]);
                  }
                  if (result0 === null) {
                    pos = pos0;
                  }
                  if (result0 === null) {
                    ...
                    if (result0 !== null) {
                      result0 = (function(offset, v, args, body) { return { tag:"define",
                                       name:v, args:args, body:body }; })(pos0, result0[3], result0[7], result0[13]);
                    }
                    if (result0 === null) {
                      pos = pos0;
                    }
